...
export default function TestSetCard({ testSet }: { testSet: TestSet }) {
  ...
  return (
    ...
    >
      <div className={`flex-shrink-0 mt-0.5 px-2 py-0.5 text-xs border rounded-md ${STATUS_STYLES[testSet.status]}`}>
      ...
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="flex-shrink-0 mt-0.5 text-gray-700">
